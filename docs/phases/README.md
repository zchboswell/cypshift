...
`R2_VALIDATION_CONTRACT_FROZEN`. The launch-day OpenADMET source revisions, file
...
contract is now frozen, but implementation and official acceptance remain next;
