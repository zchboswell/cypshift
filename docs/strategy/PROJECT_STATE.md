...
subprocess, practical row-space ridge, execution-mechanics overlay, and fresh
pair-system prediction fragments are accepted. Implement inner selection, the
final freezer, terminal, and deterministic synthetic end-to-end runner next.
The contract
